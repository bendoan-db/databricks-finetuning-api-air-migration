"""Train Llama 3.1 8B Instruct with Axolotl QLoRA on AI Runtime.
...
def build_axolotl_config(config: dict[str, Any]) -> dict[str, Any]:
    ...
    axolotl_config: dict[str, Any] = {
        ...
        "sample_packing": bool(config["sample_packing"]),
        "eval_sample_packing": bool(config["eval_sample_packing"]),
        ...
        "save_first_step": bool(config["save_first_step"]),
