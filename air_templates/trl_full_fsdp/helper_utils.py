"""YAML loading, formatting, and configuration validation for full-weight FSDP."""
...
def load_training_config(
    ...
    if not config["bf16"]:
        raise ValueError("Full-weight FSDP training requires training_config.bf16=true")
